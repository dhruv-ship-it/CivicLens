...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signup(department as Department, pincode, password)
    } catch (error: any) {
    ...
    <main className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Department Registration</CardTitle>
          <CardDescription>Create a new department account to manage complaints in your jurisdiction</CardDescription>
        </CardHeader>
        <CardContent>
